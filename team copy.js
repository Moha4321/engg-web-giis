...
const CORE_MEMBERS = [
  {
    ...
    domain: 'cfd',
    initials: 'EV',
    research: 'Large Eddy Simulation, compressible Navier–Stokes, turbulent boundary layers',
  ...
  },
  {
    id: 'c1',
    name: 'Dr. Marcus Kim',
    role: 'Co-Investigator / CTO',
    domain: 'ml',
    initials: 'MK',
    research: 'Physics-informed neural networks, data-driven turbulence closure, surrogate modeling',
  ...
  },
  {
    ...
    domain: 'fem',
    initials: 'AN',
    research: 'Topology optimization, isogeometric analysis, additive manufacturing constraints',
  ...
  },
  {
    ...
    domain: 'fem',
    initials: 'RM',
    research: 'Multiscale mechanics, composite materials, damage mechanics, homogenization theory',
  ...
  },
  {
    ...
    domain: 'cfd',
    initials: 'SR',
    research: 'GPU-accelerated CFD solvers, HPC mesh generation, OpenFOAM, parallel computing',
  ...
  },
  {
    ...
    domain: 'ml',
    initials: 'LC',
    research: 'Graph neural networks for mesh-based simulation, operator learning, DeepONet',
...
const SUPPORTED_MEMBERS = [
  ...
  { id:'s0',  name:'Alex Torres',     initials:'AT', domain:'cfd', role:'PhD Candidate',    anchor:'c0', semi_a:3.2, ecc:0.18, incl:15, lan:  0, aop: 30, period:1.0  },
  { id:'s1',  name:'Priya Sharma',    initials:'PS', domain:'ml',  role:'PhD Candidate',    anchor:'c1', semi_a:2.8, ecc:0.10, incl:35, lan: 60, aop: 80, period:0.85 },
  { id:'s2',  name:'Omar Hassan',     initials:'OH', domain:'fem', role:'MSc Student',      anchor:'c2', semi_a:3.5, ecc:0.30, incl:50, lan:120, aop:150, period:1.2  },
  { id:'s3',  name:'Julia Novak',     initials:'JN', domain:'cfd', role:'PhD Candidate',    anchor:'c0', semi_a:3.0, ecc:0.22, incl:10, lan:180, aop:200, period:0.95 },
  { id:'s4',  name:'Wei Zhang',       initials:'WZ', domain:'ml',  role:'Research Intern',  anchor:'c5', semi_a:2.6, ecc:0.08, incl:65, lan:240, aop:270, period:0.75 },
  { id:'s5',  name:'Ines Ferreira',   initials:'IF', domain:'fem', role:'PhD Candidate',    anchor:'c3', semi_a:3.8, ecc:0.40, incl:25, lan:300, aop:320, period:1.35 },
  { id:'s6',  name:'Ryan Park',       initials:'RP', domain:'cfd', role:'MSc Student',      anchor:'c4', semi_a:3.1, ecc:0.15, incl:42, lan: 30, aop: 50, period:1.05 },
  { id:'s7',  name:'Amara Diallo',    initials:'AD', domain:'ml',  role:'Research Intern',  anchor:'c1', semi_a:2.9, ecc:0.12, incl:58, lan: 90, aop:100, period:0.9  },
  { id:'s8',  name:'Kai Muller',      initials:'KM', domain:'fem', role:'PhD Candidate',    anchor:'c2', semi_a:4.0, ecc:0.35, incl:20, lan:150, aop:180, period:1.4  },
  { id:'s9',  name:'Lucia Bianchi',   initials:'LB', domain:'cfd', role:'Visiting Scholar', anchor:'c0', semi_a:3.4, ecc:0.20, incl:70, lan:210, aop:230, period:1.15 },
  { id:'s10', name:'Sam Okoro',       initials:'SO', domain:'ml',  role:'PhD Candidate',    anchor:'c5', semi_a:2.7, ecc:0.25, incl:32, lan:270, aop:290, period:0.8  },
  { id:'s11', name:'Hana Suzuki',     initials:'HS', domain:'fem', role:'MSc Student',      anchor:'c3', semi_a:3.6, ecc:0.28, incl:48, lan:330, aop:350, period:1.25 },
  { id:'s12', name:'Diego Morales',   initials:'DM', domain:'cfd', role:'Research Intern',  anchor:'c4', semi_a:2.5, ecc:0.05, incl:22, lan: 45, aop: 60, period:0.7  },
  { id:'s13', name:'Fatima Al-Sayed', initials:'FA', domain:'ml',  role:'PhD Candidate',    anchor:'c1', semi_a:3.3, ecc:0.45, incl:55, lan:105, aop:120, period:1.1  },
  ...
  function showMemberCard(m, type, hex) {
    ...
    if (isCore) {
      ...
      <div style="background:rgba(0,0,0,0.4);border:1px solid rgba(255,255,255,0.06);border-radius:4px;padding:12px 14px;margin-bottom:14px;">
        <div style="font-family:var(--font-mono);font-size:.6rem;letter-spacing:.14em;color:var(--text-tertiary);margin-bottom:6px;">RESEARCH FOCUS</div>
